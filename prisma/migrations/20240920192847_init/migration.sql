...
CREATE TABLE "order_item_prices" (
    ...
    CONSTRAINT "order_item_prices_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "orders" ADD CONSTRAINT "orders_promo_code_id_fkey" FOREIGN KEY ("promo_code_id") REFERENCES "PromoCode"("code") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "order_item_prices" ADD CONSTRAINT "order_item_prices_order_item_id_fkey" FOREIGN KEY ("order_item_id") REFERENCES "order_items"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
